...
<!-- 				<progress :percent="item.process" activeColor="#0262e5" :backgroundColor="item.process == 100 || item.process == undefined ? '#0262e5' : '#F56C6C'"
				 stroke-width="2" v-if="mode == 'create' && showProcess" /> -->
				<view class="del" @tap="deleteItem(key)">删除</view>
			</view>
		</view>
</template>
