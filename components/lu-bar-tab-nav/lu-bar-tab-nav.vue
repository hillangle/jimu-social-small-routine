<template>
	<view :id="'luBarTabNav'+barId" class="lu-bar-tab-nav">
		<scroll-view scroll-x="true" show-scrollbar="false" @scroll="scroll" v-if="!!barFixed" id="luTabFixed" class="lu-bar-tab lu-bar-tab-fixed scroll-view_H" :style="{ top: barTopStyles,height:barHeightStyles,display:barShowStyles }">
